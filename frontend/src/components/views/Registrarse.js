          ...
          <form className="container__form">
            ...
            <div className="combobox_TipoDocu">
              ...
              <select className="options__tipoDocu" required>
                ...
                <option className="options">Cedula de ciudadania (C.C)</option>
                <option className="options">Tarjeta de identidad (TI)</option>
                <option className="options">Pasaporte</option>
              </select>
            </div>
